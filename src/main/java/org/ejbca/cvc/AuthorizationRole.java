 ...
 * @version $Id: AuthorizationRole.java 23378 2016-05-09 12:55:41Z netmackan $
 */
public interface AuthorizationRole {
    ...
    /**
     * @return true if the certificate holder is a Document Verifier
     *         (Domestic/Official)
     */
    ...
    /**
     * @return true if the certificate holder is a Document Verifier (Accreditation
     *         Body)
     */
    boolean isAccreditationBodyDV();

    /**
     * @return true if the certificate holder is a Document Verifier (Certification
     *         Service Provider)
     */
